...
infile = ['file:/afs/cern.ch/user/s/sschwart/work/Shared/SingleMuLowPt_5GeVto200GeV_GEN_SIM_DIGI_L1_4_9_2015.root']
...
process.tuple = cms.EDAnalyzer("rpc_tuplizer",
                               ...
                               muonsTag     = cms.InputTag(""),
                               csctfTag     = cms.InputTag("L1CSCTFTrackConverter"),
                               rpcTPTag     = cms.InputTag("L1TMuonTriggerPrimitives","RPC"),
                               cscSegTag    = cms.InputTag("cscSegments"),
                               outputFile   = cms.string("/afs/cern.ch/user/s/sschwart/work/Shared/singleMu_lowPt_clustering_5_4_15.root"),
